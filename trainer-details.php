		...
		<section class="pt-80 pb-50 trainerListingSec" style="">
			<div class="container">
				<div class="trainerListingSecinner">
					<?php
					$user_result = mysqli_query($CONN, "SELECT * FROM `user_register` WHERE `id` = '".$_REQUEST['id']."'");
										...
										<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 columnBox trainerDetailsBox">
											<div class="trainerDetails">
												...
												<div class="d-flex justify-content-between trainerDetailsTopArea">
													<h2 class="title"><?php echo $getValue['fullname'] ?></h2>
													<div class="ratingArea">
												...
												<div class="addratingBtnArea">
													<a href="#" class="explore-button addratingBtn" data-bs-toggle="modal" data-bs-target="#addReviewModal">Add Review</a>
												</div>
											</div>
																...
																<div class="review-form-wrapper">
																	<form method="post">
																		<div class="row">
																			...
																			<input class="form-control" type="hidden" value="<?php echo $getValue['id'] ?>" name="fk_user_id">
				...
				<div class="trainerDetailsReviewsArea">
				<?php
												$courseReviews = mysqli_query($CONN, "SELECT * FROM `review` WHERE `fk_course_id`= 4");
												$totalReviews = mysqli_num_rows($courseReviews);
				...
				<div class="mt-25 courses-review-comments">
													...
													<?php foreach ($courseReviews as $courseReview) : ?>
														<div class="user-review">
															<img data-src="images/profile-picture.webp" class="img-fluid lazyload" alt="">
