...
$manage_documents = mysqli_fetch_array(mysqli_query($CONN, "SELECT * FROM `page_data` WHERE `id` = '" . @$_REQUEST['edit'] . "'"));
// echo "<pre>";
...
if (isset($_REQUEST['submit']) && $_REQUEST['edit'] == '') {
    ...
    $page_meta_data = $_REQUEST['page_meta_data'];
    $page_description = $_REQUEST['page_description'];
    $page_slug = createSlug($page_title);
    $query = "INSERT INTO `page_data` (`page_title`, `page_meta_data`, `page_description`,`page_slug`,`status`) 
              VALUES ('$page_title','$page_meta_data','$page_description','$page_slug','Y')";

    mysqli_query($CONN, $query);
    header("location:add_page?created=yes");
    exit;
}
if (isset($_REQUEST['submit']) && $_REQUEST['edit'] != '') {
    $pid = $_REQUEST['edit'];
    ...
    $page_slug = createSlug($page_title);
    mysqli_query($CONN, "UPDATE page_data SET 
    ...
    header("location: add_page?updated=yes");
    exit;
}

if (isset($_REQUEST['DelId']) != '') {
    mysqli_query($CONN, "DELETE FROM `page_data` WHERE `id` = '" . $_REQUEST['DelId'] . "' ");
                ...
                <div class="mw1000 center-block" id="hidden_div" <?php if (@$_REQUEST['edit'] == '') { ?> style="display:none;" <?php } ?>>
                    ...
                    <div class="panel mb35">
                        <div class="panel-heading">
                            <span class="panel-title">Add Page Data</span>
                        </div>

                        <?php if (@$_REQUEST['created'] == 'yes') { ?>
                            <div class="alert alert-success dark alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
                                <i class="fa fa-info pr10"></i> Congrats! Page Data added successfully!
                            </div>
                        <?php } ?>
                        <?php if (@$_REQUEST['updated'] == 'yes') { ?>
                            <div class="alert alert-success dark alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
                                <i class="fa fa-info pr10"></i> Congrats! Page Data updated successfully!
                            </div>
                        <?php } ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="section row mb25">
                                            ...
                                            <div class="col-sm-8 ph10">
                                                <input type="text" name="page_title" class="gui-input" value="<?php echo @$manage_documents['page_title'] ?>"></input>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="section row mb25">
                                            <label for="training-type" class="field-label col-sm-4 ph10">Page Meta Data</label>
                                            <div class="col-sm-8 ph10">
                                                <input type="text" name="page_meta_data" class="gui-input" value="<?php echo @$manage_documents['page_meta_data'] ?>"></input>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="section row mb25">
                                            ...
                                            <div class="col-sm-8 ph10">
                                                <textarea name="page_description" id="editor1" class="gui-input" value=""><?php echo @$manage_documents['page_description'] ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                ...
                <div class="chute chute-center" style="padding-top:0rem;">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="panel">
                                <div class="panel-heading">
                                    <span class="panel-title hidden-xs">Page Data</span>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $sl = 0;
                                                $result2 = mysqli_query($CONN, "SELECT * FROM `page_data` ORDER BY `id` DESC");
                                                while ($getValue = mysqli_fetch_array($result2)) {
                                                    $sl++;
                                                ?>
                                                    <tr>
                                                        <td><?php echo $sl; ?></td>
                                                        <td class="" data-title="title"><?php echo $getValue['page_title']; ?></td>
                                                        <td class="" data-title="page_meta_data"><?php echo $getValue['page_meta_data']; ?></td>
                                                        <td class="" data-title="page_description"><?php echo $getValue['page_description']; ?></td>
                                                        <td class="text-right">
                                                            <div class="btn-group text-right">
                                                                ...
                                                                <ul class="dropdown-menu" role="menu">
                                                                    <li><a href="?edit=<?php echo $getValue['id']; ?>">Edit</a></li>
                                                                    <li><a href="add_page?DelId=<?php echo $getValue['id']; ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
