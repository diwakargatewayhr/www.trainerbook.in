...
{
    mysqli_query($CONN, "DELETE FROM `legal_services` WHERE `id` = '".$_REQUEST['DelId']."' ");
    header("location:manage_business"); exit;
}
?>
<!DOCTYPE html>
<html>
    ...
    <!--  Main Wrapper -->
        ...
        <header id="topbar" class="ph10">
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
                <a href="add-business" class="btn btn-primary btn-sm ml10" title="New Order"><span class="fa fa-plus pr5"></span>Add New</a>
                    ...
                    <div class="col-xs-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title hidden-xs"> Manage Model Profile</span>
                            </div>
                            <div class="panel-body pn">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                        <tr class="bg-light">
                                           <th class=""><i class="fa fa-picture-o" aria-hidden="true"></i></th>
                                    ...
                                    <?php
                                        $sl = 0;
                                        $result2 = mysqli_query($CONN,"SELECT * FROM `profiles` ORDER BY `id` DESC");
                                        while($getValue = mysqli_fetch_array($result2)) { 
                                        $sl++;
                                    ?>
                                        <tr>
                                            <td class="" style="text-align:left;"><img src="../upload/profiles/<?=$getValue['profile']?>" height="150" alt="" /></td>
											<td class="" style="text-align:left;"><?php echo $getValue['fullname']; ?></td>
                                            <td class=""><?php echo $getValue['phone']; ?></td>
                                            <td><?php echo $getValue['location']; ?></td>
                                            <td><?php echo $getValue['age']; ?></td>
                                            <td class="text-right">
                                                <div class="btn-group text-right">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="add-business?edit=<?php echo $getValue['id'];?>">Edit Profile</a></li>
                                                        <li><a href="manage_business?DelId=<?php echo $getValue['id']; ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
