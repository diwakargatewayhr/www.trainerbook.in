...
<body class="error-404 sb-l-o sb-r-c">
    ...
    <section id="content_wrapper">
        ...
        <section id="content" class="pn animated fadeIn">
            ...
            <div class="center-block mt100 mw800 text-center p20">
                ...
                <h2 class="mt40 mb20">The requested page cannot be found</h2>

                <h6>
                    Can't find what you need?<br/>
                    Take a moment and do a search below or start from <a href="index.html">our homepage</a>.
                </h6>
            </div>
            <div class="center-block p20 mw400 text-center">
                <form class="text-center" role="search" action="">
                    <div class="input-group add-on mw300">
                        <input type="text" class="form-control" name="keyword" placeholder="Search..." value="">
                        <div class="input-group-btn">
                            <button class="btn btn-primary" name="result" type="submit"><i class="glyphicon glyphicon-search"></i>
                            </button>
                        </div>
                    </div>
                </form>
