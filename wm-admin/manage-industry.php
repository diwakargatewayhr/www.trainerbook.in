...
$training_type = mysqli_fetch_array(mysqli_query($CONN, "SELECT * FROM `training_type` WHERE `id` = '" . @$_REQUEST['edit'] . "'"));

if (isset($_REQUEST['submit']) && $_REQUEST['training_type'] != '' && $_REQUEST['edit'] != '') {


    mysqli_query($CONN, "UPDATE `training_type` SET `training_type` = '" . $_REQUEST['training_type'] . "' WHERE id = '" . $_REQUEST['edit'] . "'");
    header("location:manage-industry?&updated=yes");
    exit;
}

if (isset($_REQUEST['submit']) && $_REQUEST['training_type'] != '' && @$_REQUEST['edit'] == '') {

    mysqli_query($CONN, "INSERT INTO `training_type` (`training_type`) VALUES ('" . $_REQUEST['training_type'] . "')");
    header("location:manage-industry?created=yes");
    exit;
}


if (isset($_REQUEST['DelId']) != '') {
    mysqli_query($CONN, "DELETE FROM `training_type` WHERE `id` = '" . $_REQUEST['DelId'] . "' ");
    header("location:manage-industry");
    exit;
}
?>
<!DOCTYPE html>
                    ...
                    <div class="panel mb35">
                        ...
                        <?php if (@$_REQUEST['created'] == 'yes') { ?>
                            <div class="alert alert-success dark alert-dismissable">
                                ...
                                <i class="fa fa-info pr10"></i> Congrats! Training Type added successfully!
                            </div>
                        <?php } ?>
                        <?php if (@$_REQUEST['updated'] == 'yes') { ?>
                            <div class="alert alert-success dark alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
                                <i class="fa fa-info pr10"></i> Congrats! Training Type updated successfully!
                            </div>
                        <?php } ?>
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="col-md-6">
                                        <div class="section row mb25">
                                            <label for="video" class="field-label col-sm-4 ph10">Training Type</label>
                                            <div class="col-sm-8 ph10">
                                                <input type="text" name="training_type" class="gui-input" value="<?php echo @$training_type['training_type'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                ...
                <div class="chute chute-center" style="padding-top:0px;">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="panel">
                                <div class="panel-heading">
                                    <span class="panel-title hidden-xs">All Training Type</span>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $sl = 0;
                                                $result2 = mysqli_query($CONN, "SELECT * FROM `training_type` ORDER BY `id` DESC");
                                                while ($getValue = mysqli_fetch_array($result2)) {
                                                    $sl++;
                                                ?>
                                                    <tr>
                                                        <td><?php echo $sl; ?></td>
                                                        <td><?php echo @$getValue['training_type']; ?></td>
                                                        <td class="text-right">
                                                            <div class="btn-group text-right">
                                                                ...
                                                                <ul class="dropdown-menu" role="menu">
                                                                    <li><a href="manage-industry?edit=<?php echo $getValue['id']; ?>">Edit</a></li>
                                                                    <li><a href="manage-industry?DelId=<?php echo $getValue['id']; ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
