...
if($_REQUEST['update'] != '')
{
	mysqli_query($CONN,"UPDATE `website_settings` SET shutdown = '".$_REQUEST['update']."' WHERE id = '1'");
	header("location:shutdown"); exit;
}
    ...
    <!-- -------------- Main Wrapper -------------- -->
		...
		<?php if($_REQUEST['update'] == 'done') { ?>
            <div class="alert alert-success dark alert-dismissable">
                ...
                <i class="fa fa-info pr10"></i> Congrats! your action is applied in the website.
            </div>
		<?php } ?>
        ...
        <form action="" method="post" enctype="multipart/form-data" name="form1">
            ...
            <div class="chute chute-center">
                <div class="mw1000 center-block">
                    ...
                    <?php if($getSettings['shutdown'] == 'N') { ?>
    					<!-- -------------- Website Offline -------------- -->
                        <div class="panel mb35">
                            <div class="panel-heading">
                                <span class="panel-title">Your Website Currently Online - <a href="shutdown?update=Y" style="color:#F00;">MAKE OFFLINE</a></span>
                            </div>
                            <div class="panel-body br-t">
                                <div class="allcp-form theme-primary">
                				<div style="padding:2px 10px 10px 10px;">You are about to take your website off the Internet. When you take your website offline, it is only available to users who are logged in.</div>
                                </div>
                            </div>
                        </div>
                    <?php } ?>

                    <?php if($getSettings['shutdown'] == 'Y') { ?>
                        <!-- -------------- Website Online -------------- -->
                        <div class="panel mb35">
                            <div class="panel-heading">
                                <span class="panel-title">Your Website Currently Offline - <a href="shutdown?update=N" style="color:#090;">MAKE ONLINE</a></span>
                            </div>
                            <div class="panel-body br-t">
                                <div class="allcp-form theme-primary">
                				<div style="padding:2px 10px 10px 10px;">You are about to take your website online. Make sure you made your website upgradations done properly.</div>
